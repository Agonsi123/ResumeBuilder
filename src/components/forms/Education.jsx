            ...
            <div className='w-full bg-white flex items-center shadow-lg p-8 md:max-w-lg md:mx-auto rounded-md mt-3'>
                <form onSubmit={handleSubmit} className="mb-4 md:flex md:flex-wrap md:justify-between">
                    <div className='flex flex-col mb-4 w-[19.6] md:w-1/2'>
                        <label className='mb-2 font-bold md:text-lg text-grey-700'>College/School Name</label>
                        <input className='border py-2 px-3 text-[12px] text-white' type="text" name='schoolName' value={formData.schoolName} onChange={handleChange}
                        placeholder='e.g remote' />
                    </div>
                    <div className='flex flex-col mb-4 w-[19.6rem] md:w-1/2 md:ml-[15.1rem]  md:mt-[-5.5rem]'>
                        <label className='mb-2 font-bold md:text-lg text-grey-700'>Qualification</label>
                        <input className='border py-2 px-3 text-[12px] text-white' type="text" name='qualification' value={formData.qualification} onChange={handleChange} placeholder='e.g MSc Geology' />
                    </div>
